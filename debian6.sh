...
# set repo
wget -O /etc/apt/sources.list "https://raw.github.com/ekanarita/esteh/master/conf/sources.list.debian6"
...
wget -O /etc/nginx/nginx.conf "https://raw.github.com/ekanarita/esteh/master/conf/nginx.conf"
mkdir -p /home/vps/public_html
echo "<pre>Setup by ekanarita | JualSSH.com | @arieonline | 7946F434</pre>" > /home/vps/public_html/index.html
echo "<?php phpinfo(); ?>" > /home/vps/public_html/info.php
wget -O /etc/nginx/conf.d/vps.conf "https://raw.github.com/ekanarita/esteh/master/conf/vps.conf"
...
cd
# install badvpn
wget -O /usr/bin/badvpn-udpgw "https://raw.github.com/ekanarita/esteh/master/conf/badvpn-udpgw"
sed -i '$ i\screen -AmdS badvpn badvpn-udpgw --listen-addr 127.0.0.1:7300' /etc/rc.local
chmod +x /usr/bin/badvpn-udpgw
screen -AmdS badvpn badvpn-udpgw --listen-addr 127.0.0.1:7300

# install mrtg
wget -O /etc/snmp/snmpd.conf "https://raw.github.com/ekanarita/esteh/master/conf/snmpd.conf"
wget -O /root/mrtg-mem.sh "https://raw.github.com/ekanarita/esteh/master/conf/mrtg-mem.sh"
...
curl "https://raw.github.com/ekanarita/esteh/master/conf/mrtg.conf" >> /etc/mrtg.cfg
...
wget -O /etc/squid/squid.conf "https://raw.github.com/ekanarita/esteh/master/conf/squid.conf"
...
wget -O bench-network.sh "https://raw.github.com/ekanarita/esteh/master/conf/bench-network.sh"
wget -O ps_mem.py "https://raw.github.com/pixelb/ps_mem/master/ps_mem.py"
wget -O limit.sh "https://raw.github.com/ekanarita/esteh/master/conf/limit.sh"
